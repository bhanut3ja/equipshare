...
const EquipmentEngineGeneralTab = () => {
  return (
    <>
          ...
          <div className="equipment-side-content">
            ...
            <div className="equipment-engine-component">
              <div className="engine-all-tabs">
                <Link className='engine-tab' style={{ background: 'grey', color: 'white', paddingTop: '10px' }} to="/EquipmentEngineGeneralTab">General</Link>
              ...
              <div className="engine-general-tab">
                <div className="general-top-header">
                  ...
                  <div className="general-checks">
                    <input type="checkbox" className='check-1 check-data' /> <span> Usage hours left</span>
                    <input type="checkbox" className='check-2 check-data' /> <span> Engine RPM</span>
                    <input type="checkbox" className='check-3 check-data' /> <span> Avg. Fuel Economy</span>
                    <input type="checkbox" className='check-4 check-data' /> <span> Speed</span>
                  </div>
                </div>
...
export default EquipmentEngineGeneralTab
