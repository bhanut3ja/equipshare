...
const EquipmentEngineFilterTab = () => {
  return (
    <>
          ...
          <div className="equipment-side-content">
            ...
            <div className="equipment-engine-component">
              <div className="engine-all-tabs">
                ...
                <Link className='engine-tab' style={{ background: 'grey', color: 'white', paddingTop: '10px' }} to="/EquipmentEngineFilterTab">Filter</Link>
                <Link className='engine-tab' to="/EquipmentEngineSummaryTab">Tire Summary</Link>
              </div>

              <div className="engine-filter-component">
                <div className="filter-form">
                  <div className="filter-first-row">
                    <div className="filter-first">
                      <label htmlFor="" style={{ marginTop: '10px' }} className="filter-label">Property:</label>
                      <select className="filter-field">
                        <option value="">Oil Temprature</option>
                        <option value="">Oil Temprature</option>
                        <option value="">Oil Temprature</option>
                        <option value="">Oil Temprature</option>
                      </select>
                    ...
                    <div className="filter-second">
                      <label htmlFor="" className="filter-label">Operator:</label>
                      <select className="filter-field">
                  ...
                  <div className="filter-second-row">
                    <label htmlFor="" className="filter-label">Operator Details:</label>
                    <input type="text" className="filter-long-field" placeholder='Description' />
                  </div>
...
export default EquipmentEngineFilterTab
